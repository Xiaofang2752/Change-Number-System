  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      ...
      >
        ...
        <span className="text-[14px] font-bold text-slate-800 flex-1">模板下载</span>
        {/* 闪亮标识 */}
      ...
      {open && (
        <div className="px-3 pb-3 pt-0.5 border-t border-slate-100">
          <p className="text-[12px] text-muted-foreground mb-2.5 leading-relaxed pt-2.5">
            点击下载最新空白模板（含占位符，请按实际填写）。后台维护，版本随发布更新。
          </p>
          {loading ? (
            <div className="text-center py-3 text-[12px] text-slate-400">加载中...</div>
          ) : (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className={`inline-flex items-center justify-center gap-1 px-2.5 py-1 rounded-md text-[11px] font-bold transition shrink-0 ${
                          item.exists
